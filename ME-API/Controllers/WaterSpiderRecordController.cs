...
namespace ME_API.Controllers
{
    ...
    public class WaterSpiderRecordController : ControllerBase
    {
        ...
        public WaterSpiderRecordController(IWaterSpiderRecordService waterSpiderRecordService, IWebHostEnvironment webHostEnvironment, IAuditRateService auditRateService)
        {
